...
2. Set tag(s), frontmatter property key:value pair(s), or title regex that matches the note you want to move. Separate multiple tags or frontmatter properties with commas. All specified conditions must match for the rule to apply.
